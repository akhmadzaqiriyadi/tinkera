...
const PortfolioSection = () => {
  ...
  const projects = [
    // Web & Mobile Development
    {
      ...
      description:
        "Platform e-commerce responsif untuk membantu petani lokal memasarkan produk hasil bumi dengan jangkauan yang lebih luas.",
      tech: ["Next.js", "React", "Node.js", "PostgreSQL"],
      results: [
        "300% peningkatan jangkauan pasar",
        "40% peningkatan pendapatan petani",
    ...
    // Graphic Design
    {
      ...
      description:
        "Paket identitas visual lengkap untuk usaha kopi spesialti dengan konsep hangat dan premium.",
    ...
    },
    {
      ...
      description:
        "Konten visual media sosial yang menarik untuk meningkatkan engagement dan brand awareness.",
      tech: ["Adobe Creative Suite", "Canva Pro", "After Effects"],
      results: [
        "75% peningkatan engagement",
        "30% pertumbuhan followers",
        "Brand recall meningkat",
      ],
      image: "🥤",
    ...
    // Video Editing
    {
      ...
      description:
        "Video promosi dinamis dengan motion graphics dan voice-over profesional untuk peluncuran gadget.",
      tech: ["Adobe Premiere Pro", "After Effects", "Audition", "Cinema 4D"],
      results: [
        "1 juta+ views",
        "25% peningkatan pre-order",
    ...
    // AI Solutions
    {
      ...
      description:
        "Sistem rekomendasi berbasis AI yang menganalisis preferensi pengguna untuk rekomendasi buku personal.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            Setiap karya mencerminkan dedikasi kami dalam menghadirkan solusi
            digital yang memberikan dampak nyata dan hasil yang terukur bagi
            klien.
          </motion.p>
        </div>
      </motion.section>
      ...
      >
        <div className="max-w-7xl mx-auto">
          {/* Grid container dengan centering untuk item ganjil */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((project, index) => (
              <motion.div
                ...
                className={`w-full max-w-sm group bg-slate-800/40 backdrop-blur-sm rounded-2xl overflow-hidden border border-slate-700/50 hover:border-slate-600/50 transition-all duration-500 mx-auto ${
                  filteredProjects.length % 3 === 2 && index >= filteredProjects.length - 2
                    ? "lg:col-span-1 lg:first-of-type:col-start-2"
                    : filteredProjects.length % 3 === 1 && index === filteredProjects.length - 1
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">
              Siap Menjadi{" "}
              <span className="text-blue-400">Proyek Berikutnya</span>?
            </h2>
            <p className="text-slate-300 text-lg leading-relaxed mb-8 max-w-3xl mx-auto">
              Setiap proyek di atas dimulai dari diskusi sederhana tentang visi
              dan kebutuhan. Mari kita wujudkan ide digital Anda menjadi
              kenyataan yang memberikan dampak nyata.
            </p>
